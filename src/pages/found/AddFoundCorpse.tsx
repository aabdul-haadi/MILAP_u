...
export function AddFoundCorpse() {
  ...
  return (
    <FormLayout title="Add Found Corpse">
      <form className="space-y-6 max-w-8xl mx-auto w-full bg-transparent">
        ...
        {/* Lost Corpse Details Section */}
        <div className="p-1 w-full">
          <div className="bg-blue-950 text-white text-center py-2 rounded-t-lg">
            <h2 className="text-lg font-semibold">Found Corpse Details</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 border border-gray-300 rounded-b-lg">
            {[
              { label: "Found Corpse Name *", placeholder: "Enter Lost Person Name" },
              { label: "Found Corpse Alias (If Any)", placeholder: "Enter Lost Person Alias" },
